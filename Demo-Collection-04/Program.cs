...
namespace Demo_Collection_04
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Dictionary<string,ushort> listCourse = new Dictionary<string, ushort>();

            //Ce Dictionaire permet d'enregistrer les courses en paire : "Produit : Quantité"
            ...
            foreach (KeyValuePair<string,ushort> enregistrementCleValeur in listCourse)
            {
